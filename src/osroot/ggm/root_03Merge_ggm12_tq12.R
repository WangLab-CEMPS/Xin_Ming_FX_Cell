...
obj <- subset(obj, subset = orig.ident != "osRoot2")
obj$orig.ident[obj$orig.ident == "osRoot1"] <- "TQ"
...
p_split <- DimPlot(obj, split.by = "orig.ident", cols = pigRutils::select_colors("col_33"))


ggsave(filename = "./Plots/osroot/ggm12_TQ_harmony_umap.pdf", p_umap, width = 12.4, height = 7)
ggsave(filename = "./Plots/osroot/ggm12_TQ_harmony_split_umap.pdf", p_split, width = 22, height = 8)


saveRDS(obj, "./dataLib/osRoot/ggm12_TQ.Rds")
