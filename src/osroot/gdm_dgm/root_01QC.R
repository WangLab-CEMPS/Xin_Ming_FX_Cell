...
samples <- c(
  dgm1 = "./rawdata/osRoot/dgm1",
  dgm2 = "./rawdata/osRoot/dgm2", 
  gdm1 = "./rawdata/osRoot/gdm1",
  gdm2 = "./rawdata/osRoot/gdm2"
)
...
for (i in seq_along(samples)) {
  ...
  # 保存处理后的对象
  saveRDS(obj, paste0("./dataLib/osRoot/gdm_dgm/", sample_name, ".rds"))
}
